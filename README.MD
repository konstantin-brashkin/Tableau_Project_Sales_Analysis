...
You can download the actual **Tableau Package Workbook** from this repository or directly by this link: [Sales Analysis Tableau Project.twbx](/Sales_Analysis_Tableau_Project.twbx/)  
Also here is the dataset I worked with: [SuperStore Sales DataSet.xlsx](/SuperStore_Sales_DataSet.xlsx/)
